...
import { Clock, CheckCircle2, AlertTriangle, Loader2, ChevronRight } from 'lucide-react'
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className="flex justify-end">
        <Button
          disabled={Object.keys(answers).length < questions.length || submitModule.isPending}
          onClick={() => {
            const ans = questions.map((q) => ({ questionId: q._id, selected: typeof answers[q._id] === 'number' ? answers[q._id] as number : undefined, text: typeof answers[q._id] === 'string' ? answers[q._id] as string : undefined }))
